...
interface CampaignCategoryItemsDialogProps {
  open: boolean;
...
const CampaignCategoryItemsDialog: React.FC<CampaignCategoryItemsDialogProps> = ({
  open,
  productOptions,
  itemSearchQuery,
  selectedProductIds,
    ...
    <Dialog open={open} onClose={onClose} maxWidth="sm" fullWidth>
      <DialogContent sx={{ p: theme.spacing.lg }}>
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: theme.spacing.md }}>
          ...
          >
            {t('admin.campaignEditor.dialog.addRemoveItemsFromMenu')}
          </Typography>

          <TextField
            fullWidth
            placeholder={t('admin.campaignEditor.dialog.searchProductsPlaceholder')}
          ...
          >
            ...
            {filteredProductOptions.length === 0 && (
              <ListItem>
                <ListItemText
                  primary={t('admin.campaignEditor.dialog.noProductsFound')}
...
export default CampaignCategoryItemsDialog;
